 ...
 */
class DetailsScreen(carContext: CarContext, val id: Int) : Screen(carContext) {
    init {
    ...
    override fun onGetTemplate(): Template {
        ...
        val place = PlacesRepository().getPlace(id) ?: return MessageTemplate.Builder("Place Not Found")
